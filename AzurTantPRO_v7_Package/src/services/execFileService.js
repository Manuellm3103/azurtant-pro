/**
 * execFileService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: execFile
 */
class ExecFileService {
  constructor() {
    this.name = 'execFileService';
    this.ready = true;
...
const instance = new ExecFileService();
export const execFile = instance;
