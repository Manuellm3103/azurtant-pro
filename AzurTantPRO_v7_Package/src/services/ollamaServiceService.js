/**
 * ollamaServiceService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: ollamaService
 */
class OllamaServiceService {
  constructor() {
    this.name = 'ollamaServiceService';
    this.ready = true;
...
const instance = new OllamaServiceService();
export const ollamaService = instance;
