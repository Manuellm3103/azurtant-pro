/**
 * presentationModeService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: presentationMode
 */
class PresentationModeService {
  constructor() {
    this.name = 'presentationModeService';
    this.ready = true;
  ...
  async getLiveFeed(...args) { return { id: null, stub: true }; }
...
const instance = new PresentationModeService();
export const presentationMode = instance;
// method exports for direct namespace access
export const getDashboard = (...args) => instance.getDashboard(...args);
export const getLiveFeed = (...args) => instance.getLiveFeed(...args);
