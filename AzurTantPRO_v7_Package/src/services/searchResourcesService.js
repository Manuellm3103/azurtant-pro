/**
 * searchResourcesService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: searchResources
 */
class SearchResourcesService {
  constructor() {
    this.name = 'searchResourcesService';
    this.ready = true;
...
const instance = new SearchResourcesService();
export const searchResources = instance;
