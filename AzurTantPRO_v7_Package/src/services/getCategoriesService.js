/**
 * getCategoriesService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: getCategories
 */
class GetCategoriesService {
  constructor() {
    this.name = 'getCategoriesService';
    this.ready = true;
...
const instance = new GetCategoriesService();
export const getCategories = instance;
