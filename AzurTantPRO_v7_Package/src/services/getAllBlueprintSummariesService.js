/**
 * getAllBlueprintSummariesService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: getAllBlueprintSummaries
 */
class GetAllBlueprintSummariesService {
  constructor() {
    this.name = 'getAllBlueprintSummariesService';
    this.ready = true;
...
const instance = new GetAllBlueprintSummariesService();
export const getAllBlueprintSummaries = instance;
