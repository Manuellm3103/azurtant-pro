/**
 * getOpenAPISpecService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: getOpenAPISpec
 */
class GetOpenAPISpecService {
  constructor() {
    this.name = 'getOpenAPISpecService';
    this.ready = true;
...
const instance = new GetOpenAPISpecService();
export const getOpenAPISpec = instance;
