/**
 * getStatsService - Service (STUB FUNCIONAL)
 * =====================================
 * Stub generado automáticamente. Métodos que server.mjs espera.
 * Aliases exportados: getStats
 */
class GetStatsService {
  constructor() {
    this.name = 'getStatsService';
    this.ready = true;
...
const instance = new GetStatsService();
export const getStats = instance;
